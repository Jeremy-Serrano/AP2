...
"<th>Age</th>";echo "<th>ville</th>";echo "<th>mail</th>";echo "<th>Poste</th>";
echo "<th>sportAvant</th>";
...
echo "<td><input type='text' name='idAdherents' size='10'
value=".stripslashes($donnees ['idAdherents'])."></td>";
echo "<td><input type='text' name='Nom' size='10'
value='".stripslashes($donnees ['Nom'])."'></td>";
echo "<td><input type='text' name='Prenom' size='10'
value='".stripslashes($donnees ['Prenom'])."'></td>";
echo "<td><input type='text' name='Age' size='10'
value='".stripslashes($donnees ['Age'])."'></td>";
echo "<td><input type='text' name='ville' size='10'
value='".stripslashes($donnees ['ville'])."'></td>";
echo "<td><input type='text' name='mail' size='10'
value='".stripslashes($donnees ['mail'])."'></td>";
echo "<td><input type='text' name='Poste' size='10'
value='".stripslashes($donnees ['Poste'])."'></td>";
echo "<td><input type='text' name='sportAvant' size='10'
